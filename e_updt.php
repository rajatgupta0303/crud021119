...
$result = "UPDATE `emp` SET `first_name`='$Fname',`last_name`='$Lname',`dob`='$Dob',`gender`='$Gender',`join_date`='$join_date' WHERE emp_id";
...
//UPDATE emp INNER JOIN salary USING (emp_id) SET emp.first_name='new one', emp.last_name='new two', emp.dob='2019-02-02 00:00:00', emp.gender='F', emp.join_date='2016-02-02 00:00:00',
salary.salary_amount='10000'.,  WHERE emp_id=12